<template>
  <button
    ...
    :class="{
      ...
      'border border-gray-900 text-gray-200 bg-transparent active:bg-[#322538] hover:bg-[#45344f]': defaultBtn && !props.disabled,
...
const defaultBtn = computed(() => !props.primary && !props.danger && !props.error);
const defaultSize = computed(() => !props.sm && !props.lg);
...
//   return {
//     'text-white bg-[#5B53FF] hover:bg-[#5237F9]': props.primary,
//     'text-black border border-gray-900 text-gray-200 bg-transparent active:bg-[#1f141b] hover:bg-[#31202b]': defaultBtn && !props.disabled,
//     'text-white bg-red-600 hover:bg-red-500': (props.error || props.danger) && !props.disabled,
//     'bg-opacity-50 hover:bg-opacity-50 hover:auto': props.primary && props.disabled,
//     'bg-gray-500 text-gray-400 border border-gray-400 hover:auto': props.disabled && !props.primary,
//     'w-full': props.fill,
