<template>
  <div class="h-full w-full flex flex-col border border-[#5e5e8b] rounded-md">
    <router-link
    ...
    >
      ...
      <div class="h-12 border-t border-t-[#5e5e8b] bg-[#38364e] flex flex-row items-center p-2 text-white">
          {{ media.name }}
      </div>
    </router-link>
  </div>
